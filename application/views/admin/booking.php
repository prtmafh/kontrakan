                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?= base_url('admin/approve_booking/' . $booking->id_booking); ?>" class="btn btn-success btn-sm">
                                                        <i class="fas fa-check"></i> Setujui
                                                    </a>
                                                    <a href="<?= base_url('admin/reject_booking/' . $booking->id_booking); ?>" class="btn btn-danger btn-sm">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $('#paymentModal').on('show.bs.modal', function(event) {
                            ...
                            $('#approvePaymentBtn').attr('href', '<?= base_url("admin/approve_payment/"); ?>' + bookingId);
                            $('#rejectPaymentBtn').attr('href', '<?= base_url("admin/reject_payment/"); ?>' + bookingId);
                        });
                    });
                </script>
